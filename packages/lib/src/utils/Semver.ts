...
export function toSemanticVersion(
  version: string | RawSemanticVersion,
  ...
  if (isString(version)) {
    ...
    version = (version as RawSemanticVersion).map(Number) as [
      number,
      number,
      number
    ];
...
export function semanticVersionToString(
  version: string | RawSemanticVersion,
): string | never {
...
export function semanticVersionEqual(
  v1: string | RawSemanticVersion,
  v2: string | RawSemanticVersion,
): boolean {

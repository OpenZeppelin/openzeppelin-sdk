...
export default function shouldBehaveLikeOwnable(owner: string, anotherAccount: string): any {
  describe('owner', function(): any {
    it('sets the creator as the owner of the contract', async function(): Promise<any> {

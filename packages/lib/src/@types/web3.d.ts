/*
 * Web3 v0.x typings from https://www.npmjs.com/package/web3-typescript-typings.
 * The code is recycled here for custom maintainance.
 */
...
declare module 'web3' {
    ...
    namespace Web3 {
        ...
        interface EthApi {
            ...
            // TODO block param
            // NOTE: The Web3 documentation describes the position to be a number,
            // but in reality it is of type any, and using string allows for usage of large hex strings,
            // As is needed by zOS.
            getStorageAt(address: string, position: string): string;
            getStorageAt(address: string, position: string, callback: (err: Error, storage: string) => void): void;

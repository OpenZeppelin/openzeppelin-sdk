...
export class ExtendsFromShouldHaveInitialize extends TC.TypeChainContract {
  ...
  ): Promise<ExtendsFromShouldHaveInitialize> {
    const contract = new ExtendsFromShouldHaveInitialize(web3, address);
  ...
  public get someOtherValue(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.someOtherValue, []);
  }

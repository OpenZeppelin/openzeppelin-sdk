...
export class DoesNotNeedAnInitialize extends TC.TypeChainContract {
  ...
  ): Promise<DoesNotNeedAnInitialize> {
    const contract = new DoesNotNeedAnInitialize(web3, address);

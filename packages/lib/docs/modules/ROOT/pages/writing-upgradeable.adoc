...
contract MyContract {
    ...
    function initialize(uint256 _x) public {
        require(!initialized, "MyContract: already initialized");
        initialized = true;
        x = _x;
    }
}
...
[source,solidity]
----
// @openzeppelin/contracts-ethereum-package/token/ERC20/ERC20.sol
...
contract MyContract is Initializable {
    ...
    function initialize() public initializer {
        token = new ERC20("MyToken", "MYT"); // This contract will not be upgradeable
    }
}
----
...
contract MyContract is Initializable {
    ERC20UpgradeSafe public token;

    function initialize(ERC20UpgradeSafe _token) public initializer {

...
import { contractMethodsFromAst, contractMethodsFromAbi } from '../../../src/artifacts/Contract';
...
contract.only('Contract', function(accounts) {
   ...
   */
    describe('#contractMethodsFromAst', function() {
      context('when querying constant methods', function() {
        beforeEach('set methods', function() {
          this.methods = contractMethodsFromAst(InitializableMock, true);
        });
      ...
      context('when querying non-constant methods', function() {
        beforeEach('set methods', function() {
          this.methods = contractMethodsFromAst(InitializableMock, false);
        });
    ...
    describe('#contractMethodsFromAbi', function() {
      context('when querying constant methods', function() {
        beforeEach('set methods', function() {
          this.methods = contractMethodsFromAbi(InitializableMock, true);
        });
      ...
      context('when querying constant methods', function() {
        beforeEach('set methods', function() {
          this.methods = contractMethodsFromAbi(InitializableMock, false);
        });

...
export default function shouldBehaveLikeUpgradeabilityProxy(
  createProxy,
  proxyAdminAddress,
  proxyCreator,
) {
  ...
  before('deploy implementation', async function() {
    this.implementation = utils.toChecksumAddress(
      (await DummyImplementation.new()).address,
    );
  });

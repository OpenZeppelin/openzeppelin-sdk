...
var _validate = require('../../scripts/validate');
...
(0, _runWithTruffle2.default)(options => (0, _validate2.default)(options), { network, from }).then(console.log).catch(console.error);
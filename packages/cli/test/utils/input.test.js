...
describe('input', function() {
  describe('parseArgs', function() {
    ...
    it(
      'should parse a positive scientific notation number',
      testFn('1e2', '100'),
    );
    it(
      'should parse a negative scientific notation number',
      testFn('-1e2', '-100'),
    );
    it(
      'should parse a consecutive scientific notation numbers',
      testFn('1e2,2e2', '100', '200'),
    );
    it(
    ...
    it(
      'should parse another scientific notation number',
      testFn('1.5e20', '150000000000000000000'),
    );
    ...
    it(
      'should parse a quoted multiword string',
      testFn('"foo bar baz"', 'foo bar baz'),
    );
    it(
      'should parse multiple quoted words',
      testFn('"foo","bar","baz"', 'foo', 'bar', 'baz'),
    );
    ...
    it(
      ...
      testFn(
        '0x39af68cF04Abb0eF8f9d8191E1blalala',
        '0x39af68cF04Abb0eF8f9d8191E1blalala',
      ),
    );
    it(
  ...
  describe('parseMethodParams', function() {
    ...
    it(
      ...
      testFn({ init: true }, defaulMethodName, []),
    );
    it(
      'should init when args is set',
      testFn({ args: '20' }, defaulMethodName, ['20']),
    );
    it(
    ...
    it(
      ...
      testFn({ init: 'foo', args: '20' }, 'foo', ['20']),
    );
  });
});

...
describe('link command', function() {
  ...
  itShouldParse('should call link script with a list of dependencies and no install', 'link', 'zos link mock-stdlib@1.1.0 mock-stdlib2@1.2.0 --no-install', function(link) {
    const dependencies = ['mock-stdlib@1.1.0', 'mock-stdlib2@1.2.0']
    link.should.have.been.calledWithExactly({ dependencies, installDependencies: undefined })
  })

...
Note that for the Ethereum Package to be used by others, you need to use a real network instead of your local development one. We have a guide about xref:mainnet.adoc[Deploying to mainnet] which can be useful.
